...
#### Phase 1: Core Applications (`bootstrap/helmfile.d/01-apps.yaml`)
...
|---|---|---|
| **🔧 Talos Bootstrap** | `task bootstrap:talos` | `talosctl bootstrap` controller + kubeconfig export |
| **🚀 Apps Bootstrap** | `task bootstrap:apps` | Apply resources → CRDs → Helmfile sync |
